...
add_action( 'admin_menu', 'dsbl_settings_profile_add' );
add_action( 'admin_head', 'dsbl_user_profile' );

function dsbl_settings_profile_add() { // Set up plugin settings page
    add_submenu_page(
        ...
        'dsbl_settings_profile_init' // Callback Function
        );
}
...
function dsbl_settings_profile_init() { // Save checkbox values in an array and display a success message
    ...
    <div class="wrap">
        ...
        <p>Simply the <a href="./profile.php">User Profile</a> by removing fields your users don't need and removing or changing the section header text.</p>
