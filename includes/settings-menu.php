                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        foreach ( $submenu as $group => $item ) {
                                            foreach ( $item as $key ) {
                                        ?>
                                                <label for="<?php echo ( $key[2] ); ?>">
                                                <input name="remove_menu[]" type="checkbox" value="<?php echo( $key[2] ); ?>" <?php if ( is_array( $sidebar_menu ) && in_array( $key[2], $sidebar_menu ) ) { echo 'checked="checked" '; } ?> />
                                                -- <?php echo ( $key[0] ); ?></label>
                                                <br>
                                        <?php
                                            }
                                         } ?>
